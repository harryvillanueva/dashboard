            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Nueva Página Web</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-8 mx-auto">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Información de la Página Web</h3>
                        </div>
                        <form action="index.php?controller=paginas-web&action=crear" method="POST" enctype="multipart/form-data">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="descripcion" name="descripcion" 
                                              rows="3" placeholder="Descripción de la página web"><?= $_POST['descripcion'] ?? '' ?></textarea>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" id="fecha_vencimiento_hosting" name="fecha_vencimiento_hosting" 
                                                   value="<?= $_POST['fecha_vencimiento_hosting'] ?? '' ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="card-footer">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fas fa-save"></i> Guardar Página Web
                                </button>
